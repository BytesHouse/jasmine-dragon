...
const Dropdown = ({ array }) => {
    ...
    return (
        <div className="dropdown flex items-center justify-center bg-[var(--green-light)] w-[300px] border border-[var(--blue-light)] [&>div] font-[var(--Nunito-sans)] text-[var(--blue-light)] relative [&_li]:border [&_li]:border-[var(--blue-light)] [&_li]:p-4 [&_ul]:absolute">
            {typeof array[0] === "string" ? (
                ...
                <div>
                    <div className="flex items-center justify-center gap-[15px] py-[15px] " onClick={handleChangeIsShow}>
