...
const UserProfile = () => {
    ...
    return (
        <div className="flex col-span-12 mt-[50px] flex relative gap-[50px]">
            ...
            <input className="w-[700px] border border-blue-light bg-[var(--green-bg)] p-4 focus:outline-none"  type="text"></input>
            <img className="absolute mt-[3.7%] ml-[43%] w-[36px] h-[36px]"  src={pen} alt="redact"></img>
            </div>
            <div className="flex flex-col gap-[15px]">
