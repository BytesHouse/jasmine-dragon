...
const DescriptionBlock = ({ product }) => {
  const { name, type, subtype, weight, description, strength, brewRes } =
    product;
  return (
    <section className="flex gap-[25px]">
      ...
      <div className="w-full flex flex-col gap-[25px]">
        ...
        <div className="grid grid-cols-3 gap-[50px]">
          <Counter />
          <button className="cursor-pointer text-[1.5rem] py-[27px] flex justify-center items-center gap-[25px] col-span-2 border border-[var(--blue-light)]">
            <span>
              <svg
                width="23"
                height="24"
